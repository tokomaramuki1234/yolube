          ...
          <div className="training-instructor-profile">
            ...
            <div className="training-instructor-content">
              ...
              <div className="training-instructor-message">
                <h5>研修を始めた理由</h5>
                <p>
                  YOLUBEは「テーブルゲームを通じて秋田県内の社会課題を解決する」ことを目的に創立しました。<span className="emphasis-benefit">秋田県をはじめとする地方都市では、人口流出に伴う社員の定着率低下</span>が大きな課題となっています。
                </p>
                <p>
                  この課題の解決には、エンゲージメント（企業と従業員の間に生まれる深い結びつきや愛着）の向上が重要です。<span className="highlight">社内コミュニケーションの活性化</span>を通じて、地元企業に共通する「社員の定着率向上」に貢献したいと考え、本サービスを開発いたしました。
                </p>
                <p>
                  これ以上、地元が衰退していく姿を見ていられない。同じ想いをお持ちの方々とは、本サービスのご利用に関わらず協力していきたいと考えております。どうぞよろしくお願いいたします。
                </p>
              </div>
            </div>
          </div>
